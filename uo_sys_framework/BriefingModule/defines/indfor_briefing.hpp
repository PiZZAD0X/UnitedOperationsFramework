if (GETMVAR(File_INDFOR,false)) exitwith {
    if !(GETMVAR(File_Path_INDFOR,"") isEqualto "") then {
        "" call (compile preprocessFileLineNumbers GETMVAR(File_Path_INDFOR,""));
    } else {
        ERROR("No briefing found for INDFOR!");
    };
};

if (GETMVAR(NATO_INDFOR,false)) then {
    //Situation
    private _situationStr = "";

    private _situationMain = GETMVAR(NATO_SIT_Main_INDFOR,"");
    ...
    private _situationTerrain = GETMVAR(NATO_SIT_Terrain_INDFOR,"");
    ...
    private _situationKey = GETMVAR(NATO_SIT_KEYTerrain_INDFOR,"");
    ...
    private _situationWeather = GETMVAR(NATO_SIT_Weather_INDFOR,"");
    ...
    private _enemyDisposition = GETMVAR(NATO_Enemy_DIS_INDFOR,"");
    ...
    private _enemyStrength = GETMVAR(NATO_Enemy_STRENGTH_INDFOR,"");
    ...
    private _enemyEquipment = GETMVAR(NATO_Enemy_EQUIPMENT_INDFOR,"");
    ...
    private _enemyAppearance = GETMVAR(NATO_Enemy_APPEARANCE_INDFOR,"");
    ...
    private _friendlyDisposition = GETMVAR(NATO_FRIENDLY_DIS_INDFOR,"");
    ...
    private _friendlyHigher = GETMVAR(NATO_FRIENDLY_DIS_INDFOR,"");
    ...
    private _missionNato = GETMVAR(NATO_Mission_INDFOR,"");
    ...
    private _execCIntent = GETMVAR(NATO_EXECUTION_INTENT_INDFOR,"");
    ...
    private _execManeuver = GETMVAR(NATO_EXECUTION_INTENT_INDFOR,"");
    ...
    private _execTimings = GETMVAR(NATO_EXECUTION_Timings_INDFOR,"");
    ...
    private _serviceGen = GETMVAR(NATO_SANDS_SERVICE_GENERAL_INDFOR,"");
    ...
    private _commandGen = GETMVAR(NATO_CANDS_COMMAND_INDFOR,"");
    ...
    private _signalFreq = GETMVAR(NATO_CANDS_Signals_FREQ_INDFOR,"");
    ...
    private _signalCode = GETMVAR(NATO_CANDS_Signals_CODEWORDS_INDFOR,"");
    ...
    private _signalSpec = GETMVAR(NATO_CANDS_Signals_SPECIAL_INDFOR,"");
    ...
    private _signalCall = GETMVAR(NATO_CANDS_Signals_CALLSIGNS_INDFOR,"");
...
if (GETMVAR(Warsaw_INDFOR,false)) then {

    private _preStr = "";

    private _preWeather = GETMVAR(Warsaw_Preliminaries_Weather_INDFOR,"");
    if !(_preWeather isEqualTo "") then {
        _preStr = _preStr + "<font color='#5BD527' size='14.0'><h1>Weather:</h1></font color><br/>" + _preWeather + "<br/><br/>";
    };

    private _preTerrain = GETMVAR(Warsaw_Preliminaries_Terrain_INDFOR,"");
    ...
    private _refpointsDep = GETMVAR(Warsaw_Reference_DeploymentPoints_INDFOR,"");
    ...
    private _refpointsSub = GETMVAR(Warsaw_Reference_SubsequentPoints_INDFOR,"");
    ...
    private _enLoc = GETMVAR(Warsaw_Enemy_Prob_Line_INDFOR,"");
    ...
    private _enDir = GETMVAR(Warsaw_Enemy_Prob_Dir_Attack_INDFOR,"");
    ...
    private _higherDesc = GETMVAR(Warsaw_Higher_Disp_INDFOR,"");
    ...
    private _higherBound = GETMVAR(Warsaw_Higher_Boundary_INDFOR,"");
    ...
    private _higherLocArty = GETMVAR(Warsaw_Higher_Arty_INDFOR,"");
    ...
    private _missionStat = GETMVAR(Warsaw_Mission_Desc_INDFOR,"");
    ...
    private _missionDir = GETMVAR(Warsaw_Mission_DIR_INDFOR,"");
    ...
    private _orderTimings = GETMVAR(Warsaw_Order_Timings_INDFOR,"");
    ...
    private _orderSignals = GETMVAR(Warsaw_Order_Signals_INDFOR,"");
    ...
    private _cmdlocDesc = GETMVAR(Warsaw_COMM_LOC_INDFOR,"");
    ...
    private _succDesc = GETMVAR(Warsaw_SUCC_DESC_INDFOR,"");
...
if (GETMVAR(Appendix_INDFOR,false)) then {
    if !(GETMVAR(Appendix_Path_INDFOR,"") isEqualto "") then {
        "" call (compile preprocessFileLineNumbers (GETMVAR(Appendix_Path_INDFOR,"")));
    } else {
