...
if (GETMVAR(NATO_OPFOR,false)) then {
    //Situation
    private _situationStr = "";

    private _situationMain = GETMVAR(NATO_SIT_Main_OPFOR,"");
    ...
    private _situationTerrain = GETMVAR(NATO_SIT_Terrain_OPFOR,"");
    ...
    private _situationKey = GETMVAR(NATO_SIT_KEYTerrain_OPFOR,"");
    ...
    private _situationWeather = GETMVAR(NATO_SIT_Weather_OPFOR,"");
    ...
    private _enemyDisposition = GETMVAR(NATO_Enemy_DIS_OPFOR,"");
    ...
    private _enemyStrength = GETMVAR(NATO_Enemy_STRENGTH_OPFOR,"");
    ...
    private _enemyEquipment = GETMVAR(NATO_Enemy_EQUIPMENT_OPFOR,"");
    ...
    private _enemyAppearance = GETMVAR(NATO_Enemy_APPEARANCE_OPFOR,"");
    ...
    private _friendlyDisposition = GETMVAR(NATO_FRIENDLY_DIS_OPFOR,"");
    ...
    private _friendlyStrength = GETMVAR(NATO_FRIENDLY_STRENGTH_OPFOR,"");
    ...
    private _friendlyEquipment = GETMVAR(NATO_FRIENDLY_EQUIPMENT_OPFOR,"");
    ...
    private _friendlyAppearance = GETMVAR(NATO_FRIENDLY_APPEARANCE_OPFOR,"");
    ...
    private _missionNato = GETMVAR(NATO_Mission_OPFOR,"");
    ...
    private _execCIntent = GETMVAR(NATO_EXECUTION_INTENT_OPFOR,"");
    ...
    private _execManeuver = GETMVAR(NATO_EXECUTION_INTENT_OPFOR,"");
    ...
    private _execTimings = GETMVAR(NATO_EXECUTION_Timings_OPFOR,"");
    ...
    private _execTasks = GETMVAR(NATO_EXECUTION_Tasks_OPFOR,"");
    ...
    private _serviceGen = GETMVAR(NATO_SANDS_SERVICE_GENERAL_OPFOR,"");
    ...
    private _commandGen = GETMVAR(NATO_CANDS_COMMAND_OPFOR,"");
    ...
    private _signalFreq = GETMVAR(NATO_CANDS_Signals_FREQ_OPFOR,"");
    ...
    private _signalCode = GETMVAR(NATO_CANDS_Signals_CODEWORDS_OPFOR,"");
    ...
    private _signalSpec = GETMVAR(NATO_CANDS_Signals_SPECIAL_OPFOR,"");
    ...
    private _signalCall = GETMVAR(NATO_CANDS_Signals_CALLSIGNS_OPFOR,"");
...
if (GETMVAR(Warsaw_OPFOR,false)) then {

    private _preStr = "";

    private _preWeather = GETMVAR(Warsaw_Preliminaries_Weather_OPFOR,"");
    if !(_preWeather isEqualTo "") then {
        _preStr = _preStr + "<font color='#5BD527' size='14.0'><h1>Weather:</h1></font color><br/>" + _preWeather + "<br/><br/>";
    };

    private _preTerrain = GETMVAR(Warsaw_Preliminaries_Terrain_OPFOR,"");
    ...
    private _refpointsDep = GETMVAR(Warsaw_Reference_DeploymentPoints_OPFOR,"");
    ...
    private _refpointsSub = GETMVAR(Warsaw_Reference_SubsequentPoints_OPFOR,"");
    ...
    private _enLoc = GETMVAR(Warsaw_Enemy_Prob_Line_OPFOR,"");
    ...
    private _enDir = GETMVAR(Warsaw_Enemy_Prob_Dir_Attack_OPFOR,"");
    ...
    private _enArty = GETMVAR(Warsaw_Enemy_Prob_Arty_OPFOR,"");
    ...
    private _higherDesc = GETMVAR(Warsaw_Higher_Disp_OPFOR,"");
    ...
    private _higherBound = GETMVAR(Warsaw_Higher_Boundary_OPFOR,"");
    ...
    private _higherLocArty = GETMVAR(Warsaw_Higher_Arty_OPFOR,"");
    ...
    private _missionStat = GETMVAR(Warsaw_Mission_Desc_OPFOR,"");
    ...
    private _missionDir = GETMVAR(Warsaw_Mission_DIR_OPFOR,"");
    ...
    private _orderTimings = GETMVAR(Warsaw_Order_Timings_OPFOR,"");
    ...
    private _orderSignals = GETMVAR(Warsaw_Order_Signals_OPFOR,"");
    ...
    private _cmdlocDesc = GETMVAR(Warsaw_COMM_LOC_OPFOR,"");
    ...
    private _succDesc = GETMVAR(Warsaw_SUCC_DESC_OPFOR,"");
...
if (GETMVAR(Appendix_OPFOR,false)) then {
    if !(GETMVAR(Appendix_Path_OPFOR,"") isEqualto "") then {
        "" call (compile preprocessFileLineNumbers (GETMVAR(Appendix_Path_OPFOR,"")));
    } else {
