if (GETMVAR(Enabled_2,false)) then {
    if ((isNil QGVAR(Message_2)) || {!(GETMVAR(Message_2,"") isEqualType "STRING")}) then {
        ...
        if (!(GETMVAR(EntitiesDamaged_Array_2,[]) isEqualto [])) then {_conditionsCountCategory2 = _conditionsCountCategory2 + 1;};
        if (!(GETMVAR(HostageRescued_Array_2,[]) isEqualto [])) then {_conditionsCountCategory2 = _conditionsCountCategory2 + 1;};
        ...
        if ((_conditionsCountCategory2) > 0) then {
            ...
            private _endConditionsCategory2PFHhandle = [{
                ...
                if (GETMVAR(CasualtyCount_Enabled_BLUFOR_2,false)) then {
                    ...
                    if (_westCasualty >= GETMVAR(CasualtyCount_Enabled_Percentage_BLUFOR_2,75)) then {_CasConditionCheck_Blufor = true;} else {_CasConditionCheck_Blufor = false;};
                ...
                if (GETMVAR(CasualtyCount_Enabled_OPFOR_2,false)) then {
                    ...
                    if (_eastCasualty >= GETMVAR(CasualtyCount_Enabled_Percentage_OPFOR_2,75)) then {_CasConditionCheck_Opfor = true;} else {_CasConditionCheck_Opfor = false;};
                ...
                if (GETMVAR(CasualtyCount_Enabled_Indfor_2,false)) then {
                    ...
                    if (_resCasualty >= GETMVAR(CasualtyCount_Enabled_Percentage_Indfor_2,75)) then {_CasConditionCheck_Indfor = true;} else {_CasConditionCheck_Indfor = false;};
